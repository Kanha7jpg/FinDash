...
import { createPortfolio, createPortfolioTransaction, deletePortfolio, getPortfolioDetail, getPortfolios } from '@/api/portfolio';
export const usePortfolioStore = create((set, get) => ({
    ...
    loadPortfolios: async () => {
        ...
        try {
            ...
            const selectedPortfolioId = existingSelection && portfolios.some((portfolio) => portfolio.id === existingSelection)
                ? existingSelection
