...
import { addStockToWatchlist, createWatchlist, deleteWatchlist, getWatchlists, removeStockFromWatchlist, updateWatchlistStockNotes } from '@/api/watchlists';
function updateWatchlistInCollection(collection, updated) {
